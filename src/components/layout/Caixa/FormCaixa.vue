          ...
          <div class="row g-4">
            <div class="col-12">
              <div class="bg-secondary rounded h-100 p-4 text-light">
                ...
                <form @submit.prevent="cadastrarCaixa">
                  <div class="row mb-3">
                    <div class="col-md-6">
                      <label for="data_abertura" class="form-label">Data de Abertura</label>
                      <input type="datetime-local" class="form-control" id="data_abertura" v-model="caixa.data_abertura" required />
                    </div>
                    <div class="col-md-6">
                  ...
                  <div class="row mb-3">
                    <div class="col-md-6">
                      ...
                      <input type="datetime-local" class="form-control" id="data_fechamento" v-model="caixa.data_fechamento" />
                    </div>
                    <div class="col-md-6">
                  ...
                  <div class="row mb-3">
                    <div class="col-md-6">
                      ...
                      <select class="form-select" id="status" v-model="caixa.status" required>
                    ...
                    <div class="col-md-6">
                      ...
                      <textarea class="form-control" id="observacao" rows="2" v-model="caixa.observacao" placeholder="Observações sobre o caixa"></textarea>
                    </div>
                  </div>
...
const cadastrarCaixa = () => {
  console.log('Caixa cadastrado:', caixa)
