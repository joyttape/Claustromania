 ...
 <div class="sidebar pe-4 pb-3">
  <nav class="navbar bg-secondary navbar-dark">
    ...
    <div class="navbar-nav w-100">
      ...
      <router-link v-if="cargo !== 'Estagiário'" to="/caixa" class="nav-item nav-link">
      ...
      <router-link v-if="cargo === 'Gerente'" to="/funcionarios" class="nav-item nav-link">
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      cargo.value = localStorage.getItem('cargoFuncionario') || ''
    })
